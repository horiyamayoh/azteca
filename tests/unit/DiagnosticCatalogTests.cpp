...
TEST(DiagnosticCatalog, PublicMappingTargetsRegisteredIds)
{
	...
	for (auto const& internal :
	    {"AZTECA_ANONYMOUS_UNION_PARTIAL", "AZTECA_BIT_FIELD_PARTIAL", "AZTECA_CLANG_PARSE_FAILED",
	        "AZTECA_COMPILE_DB_EMPTY", "AZTECA_COMPILE_DB_LOAD_FAILED", "AZTECA_COMPILE_DB_MISSING",
