...
TEST(DiagnosticCatalog, PublicMappingTargetsRegisteredIds)
{
	...
	for (auto const& internal : {"AZTECA_ANONYMOUS_UNION_PARTIAL", "AZTECA_BIT_FIELD_PARTIAL",
	         "AZTECA_CLANG_PARSE_FAILED", "AZTECA_CLANG_PARSE_SKIPPED", "AZTECA_COMPILE_DB_EMPTY",
	         "AZTECA_COMPILE_DB_LOAD_FAILED", "AZTECA_COMPILE_DB_MISSING",
	         "AZTECA_COMPILE_DB_SOURCE_NOT_FOUND", "AZTECA_CONSERVATIVE_CONSTRUCT",
	         "AZTECA_METHOD_AMBIGUOUS", "AZTECA_METHOD_DECL_ONLY", "AZTECA_METHOD_NO_BODY",
	         "AZTECA_METHOD_NOT_FOUND", "AZTECA_MMIR_BARE_THIS",
	         "AZTECA_MMIR_BOUNDARY_CALLEE_MISSING", "AZTECA_MMIR_FIELD_DECL_MISSING",
	         "AZTECA_MMIR_LOCATION_MISSING", "AZTECA_MMIR_UNCLASSIFIED_CALL",
	         "AZTECA_PATH_CONSERVATIVE", "AZTECA_STATIC_METHOD",
	         "AZTECA_TEMPLATE_INSTANTIATION_NOT_FOUND", "AZTECA_UNSUPPORTED_CONSTRUCT",
	         "AZTECA_UNSUPPORTED_TARGET"})
	{
